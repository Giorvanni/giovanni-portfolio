    ...
    <footer className="border-t border-white/[0.04] px-5 py-8 sm:px-8">
      <div className="mx-auto flex max-w-5xl flex-col items-center justify-between gap-4 sm:flex-row">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="https://www.linkedin.com/in/giovanni-bagmeijer-8744aa186/" target="_blank" rel="noopener noreferrer" className="text-zinc-700 transition-colors hover:text-accent">
